  ...
  return (
    <section className="flex flex-col pt-[30px] app:pt-0 app:flex-row bg-gray-100 gap-2 justify-between items-center">
      <div className="space-y-4 text-center app:text-left pt-[30px] app:pt-0 h-fill app:mx-8">    
        {(role === "helper") ? <h1 className="text-2xl app:text-xl text-gray-400 mb-2">Looking for a job?</h1> : <h1 className="text-2xl app:text-xl text-gray-400 mb-2">Looking for house help?</h1>}
        {(role === "helper") ? <h2 className="text-xl app:text-4xl font-hero text-gray-700 heroText">Find available jobs in Saudi Arabia</h2> : <h2 className="text-xl app:text-4xl font-hero text-gray-700 heroText">Find available helpers in Saudi Arabia</h2>}
        {(role === "helper") ? <p className="text-gray-400 xl:text-xl">Explore job listings and apply directly</p> : <p className="text-gray-400 xl:text-xl">Explore profiles and contact helpers directly</p>}
      ...
      <div className="mx-0 mt-4 app:mt-0 w-[64%]">
        <img src={ladyImg} alt="House helper Marofa Saudia Arabia" className="w-full" width="400" height="400" />
      </div>
    </section>
  );
};
